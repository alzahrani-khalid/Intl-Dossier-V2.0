/* DELIBERATELY-DIVERGED POSITIVE-FAILURE FIXTURE — NEVER loaded by the app.
 * Exact copy of frontend/public/bootstrap.js with EXACTLY ONE palette literal
 * changed: bureau.light.bg '#f7f6f4' -> '#f7f6f5' (a single-byte drift).
 * scripts/check-bootstrap-parity.mjs MUST exit 1 when pointed here, naming --bg
 * and the bureau/light combination. If this file ever PASSES the parity check,
 * the guard is broken and the FOUC-01 gate is no longer protecting first paint.
 */
...
(function () {
  try {
    ...
    var P = {
      ...
      bureau: {
        light:{bg:'#f7f6f5',surface:'#ffffff',surfaceRaised:'#ffffff',ink:'#1a1714',inkMute:'#6b6459',inkFaint:'#736b60',line:'#e8e4dc',lineSoft:'#efece3',sidebar:'#ffffff',sidebarInk:'#2a2520',rSm:'8px',r:'12px',rLg:'16px'},
