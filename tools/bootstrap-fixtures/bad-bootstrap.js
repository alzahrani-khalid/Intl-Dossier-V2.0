 ...
 * Exact copy of frontend/public/bootstrap.js (Plan 77-04 Linear activation) with
 * EXACTLY ONE palette literal changed: linear.dark.bg '#010102' -> '#010103' (a
 * single-byte drift). scripts/check-bootstrap-parity.mjs MUST exit 1 when pointed
 * here, naming --bg on the linear/dark byte-match (the coercion probes also assert
 * --bg == linear.dark.bg). If this file ever PASSES the parity check, the guard is
 * broken and the FOUC-01 gate is no longer protecting first paint.
 */
