...
### - [ ] T069 Create route: /engagements/:id
...
### - [ ] T070 Create route: /engagements/:id/after-action
...
### - [ ] T071 Create route: /after-actions/:id
...
### - [ ] T072 Create route: /after-actions/:id/versions
...
### - [ ] T079 [P] Integration test: User Story 1 - Log After-Action Record
...
### - [ ] T080 [P] Integration test: User Story 2 - AI-Assisted Extraction
...
### - [ ] T079 [P] Integration test: User Story 3 - Publish After-Action
...
### - [ ] T080 [P] Integration test: User Story 4 - Publish Confidential (Step-Up Auth)
...
### - [ ] T079 [P] Integration test: User Story 5 - Request and Approve Edits
...
### - [ ] T080 [P] Integration test: User Story 6 - Generate Bilingual PDF
...
### - [ ] T079 [P] Integration test: User Story 7 - External Commitment Tracking
...
### - [ ] T080 [P] Integration test: User Story 8 - Notification Preferences
...
### - [ ] T081 [P] E2E test: Attachment limit enforcement
...
### - [ ] T082 [P] E2E test: Concurrent edit conflict
...
### - [ ] T083 [P] E2E test: File size limit
...
### - [ ] T084 [P] E2E test: Invalid file type
...
### - [ ] T085 [P] E2E test: Virus detection
...
### - [ ] T086 [P] E2E test: Permission check (Dossier assignment)
...
### - [ ] T087 [P] E2E test: Staff tries to publish
...
### - [ ] T088 [P] E2E test: Low AI confidence handling
...
### - [ ] T089 Performance test: API response times
...
### - [ ] T090 Performance test: AI extraction (sync)
...
### - [ ] T091 Performance test: AI extraction (async)
...
### - [ ] T092 Performance test: PDF generation
...
### - [ ] T093 [P] Accessibility audit: Keyboard navigation
...
### - [ ] T094 [P] Accessibility audit: Screen readers (English)
...
### - [ ] T095 [P] Accessibility audit: Screen readers (Arabic)
...
### - [ ] T096 [P] Accessibility audit: Color contrast
...
### - [ ] T097 [P] Accessibility audit: Focus indicators
