...
import { useComponentCompliance } from '../../src/hooks/use-compliance'
...
describe('Performance Benchmarks', () => {
  ...
  describe('Validation Performance', () => {
    it('should complete single component validation under 500ms', async () => {
      ...
      const wrapper = ({ children }: { children: React.ReactNode }) => (
        <DesignComplianceProvider enableValidation={true}>{children}</DesignComplianceProvider>
      )
  ...
  describe('Progressive Disclosure Performance', () => {
    it('should toggle disclosure states efficiently', async () => {
      const { container } = render(
        <DesignComplianceProvider enableValidation={false}>
          <ResponsiveCard title="Collapsible" collapsible={true} defaultCollapsed={false}>
