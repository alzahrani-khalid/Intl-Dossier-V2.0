// Phase 42-04 — Activity functional E2E suite (un-skipped by plan 42-08).
//
// Covers:
...
test.describe('Phase 42 — Activity page', () => {
  ...
  test('renders .act-list with 3-col grid rows', async ({ page }) => {
  ...
  test('tabs swap All/Following', async ({ page }) => {
    await gotoPhase42Page(page, PHASE_42_ROUTES.activity)
