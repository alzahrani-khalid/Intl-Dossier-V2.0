...
export function useAfterActionList(
  ...
  options?: Omit<
    UseQueryOptions<AfterActionListResponse, AfterActionAPIError>,
    'queryKey' | 'queryFn'
  >,
) {
  return useQuery({
...
export function useUpdateAfterAction() {
  ...
  return useMutation({
    ...
    onMutate: async ({ id, data }) => {
      ...
      const previousRecord = queryClient.getQueryData<AfterActionRecord>(afterActionKeys.detail(id))
