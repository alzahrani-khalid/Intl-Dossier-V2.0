...
async function fetchPositionAnalytics(positionId: string): Promise<PositionAnalytics> {
...
async function fetchTopPositions(options: TopPositionsOptions): Promise<TopPosition[]> {
