  ...
  intake_ticket: {
    columns: [
      ...
      },
      {
        ...
        required: true,
        example: 'Request for technical collaboration',
      },
      {
      ...
      },
      {
        ...
        headerAr: 'مسند إلى (معرف المستخدم)',
        required: false,
      },
      {
        field: 'assigned_unit',
        header: 'Assigned Unit',
        headerAr: 'الوحدة المسندة',
        required: false,
        example: 'International Relations',
      },
      {
        field: 'resolution',
        header: 'Resolution (English)',
        headerAr: 'القرار (إنجليزي)',
        required: false,
      },
      {
        field: 'resolution_ar',
        header: 'Resolution (Arabic)',
        headerAr: 'القرار (عربي)',
        required: false,
      },
      {
        field: 'source',
    ...
    columns: [
      {
        ...
        headerAr: 'العنوان (إنجليزي) *',
        required: true,
        example: 'Annual Conference Opening',
      },
      {
        field: 'title_ar',
        header: 'Title (Arabic)',
        headerAr: 'العنوان (عربي)',
        required: false,
        example: 'حفل افتتاح المؤتمر السنوي',
      },
      {
        field: 'event_type',
        header: 'Event Type *',
      ...
      },
      {
        ...
        headerAr: 'الوصف (إنجليزي)',
        required: false,
        example: 'Opening ceremony for the annual conference',
      },
      {
        field: 'description_ar',
        header: 'Description (Arabic)',
      ...
      },
      {
        ...
        header: 'Start Date/Time (YYYY-MM-DDTHH:mm:ss) *',
        headerAr: 'تاريخ ووقت البدء *',
        required: true,
        example: '2025-03-15T09:00:00',
      },
      {
        field: 'end_datetime',
        header: 'End Date/Time (YYYY-MM-DDTHH:mm:ss) *',
        headerAr: 'تاريخ ووقت الانتهاء *',
        required: true,
      ...
      },
      {
        ...
        headerAr: 'الموقع (عربي)',
        required: false,
        example: 'القاعة الرئيسية للمؤتمرات',
      },
      {
        field: 'is_virtual',
        header: 'Virtual Event (true/false)',
        headerAr: 'حدث افتراضي',
        required: false,
        example: 'false',
      },
      {
        field: 'virtual_link',
        header: 'Virtual Link',
        headerAr: 'رابط الحدث الافتراضي',
        required: false,
        example: 'https://meet.example.com/conference',
      },
      {
        field: 'room_en',
        header: 'Room (English)',
        headerAr: 'القاعة (إنجليزي)',
        required: false,
        example: 'Hall A',
      },
      {
