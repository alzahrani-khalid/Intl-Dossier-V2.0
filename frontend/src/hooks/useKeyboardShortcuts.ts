  ...
  useEffect(() => {
    ...
    unregisters.push(
      register({
        ...
        key: 'w',
        modifiers: ['alt'],
        description: t('shortcuts.goToMyWork'),
        category: 'navigation',
    ...
    unregisters.push(
      register({
        ...
        key: 'o',
        modifiers: ['alt'],
        description: t('shortcuts.goToDossiers'),
        category: 'navigation',
    ...
    unregisters.push(
      register({
        ...
        key: 'c',
        modifiers: ['alt'],
        description: t('shortcuts.goToCalendar'),
        category: 'navigation',
    ...
    unregisters.push(
      register({
        ...
        key: 't',
        modifiers: ['alt'],
        description: t('shortcuts.goToTasks'),
        category: 'navigation',
    ...
    unregisters.push(
      register({
        ...
        key: 'arrowright',
        modifiers: ['alt'],
        description: t('shortcuts.goForward'),
        category: 'navigation',
