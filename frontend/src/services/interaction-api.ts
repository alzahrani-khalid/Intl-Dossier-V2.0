 ...
 *
 * Note: The interaction_notes table type is not yet generated in database.types.ts,
 * so we define all fields explicitly here.
 */
export interface InteractionNoteResponse {
  id: string
  contact_id: string
  date: string
...
/**
 * Type alias for insert operations (matches InteractionNoteResponse without auto-generated fields)
 */
type InteractionNoteUpdate = Partial<
  Omit<
    InteractionNoteResponse,
    'id' | 'created_at' | 'updated_at' | 'contact' | 'attendee_contacts'
  >
>
