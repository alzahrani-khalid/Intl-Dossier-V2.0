...
export const electedOfficialKeys = {
  ...
  list: (filters?: ElectedOfficialFilters) => [...electedOfficialKeys.lists(), { filters }] as const,
...
export function useElectedOfficials(filters?: ElectedOfficialFilters) {
  ...
  if (filters != null) {
    ...
    if (filters.is_current_term != null) params.set('is_current_term', String(filters.is_current_term))
    if (filters.country_id != null && filters.country_id !== '') params.set('country_id', filters.country_id)
