/**
 * useExportData Hook
 * @module domains/documents/hooks/useExportData
 *
 * Hook for exporting entity data to CSV, XLSX, or JSON formats.
 * Supports template generation and progress tracking.
 *
 * Note: This hook uses a specialized fetch pattern for streaming/blob
 * handling and XLSX conversion with ExcelJS. The repository provides
 * the base API call, but the XLSX post-processing and file download
 * logic lives here in the hook.
 */
