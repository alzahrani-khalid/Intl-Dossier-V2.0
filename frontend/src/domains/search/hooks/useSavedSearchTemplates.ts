...
function useSearchTemplate(id: string | null, options?: { enabled?: boolean }): ReturnType<typeof useQuery<{ data: SearchTemplate } | null>> {
  return useQuery({
...
export function useCreateTemplate(): ReturnType<typeof useMutation<{ data: SearchTemplate }, Error, CreateTemplateRequest>> {
...
function useUpdateTemplate(): ReturnType<typeof useMutation<{ data: SearchTemplate }, Error, { id: string; data: UpdateTemplateRequest }>> {
  const queryClient = useQueryClient()
...
export function useDeleteTemplate(): ReturnType<typeof useMutation<{ success: boolean }, Error, string>> {
  const queryClient = useQueryClient()
