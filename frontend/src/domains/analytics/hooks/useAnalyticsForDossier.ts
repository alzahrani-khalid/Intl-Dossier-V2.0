  ...
  switch (dossierType) {
    case 'country':
      return [
        {
          label: 'Engagements',
          value: s.upcoming_events_count ?? 0,
          i18nKey: 'analytics.engagementCount',
        },
        {
          label: 'Work Items',
          value: s.work_items_count ?? 0,
          i18nKey: 'analytics.workItemsCount',
        },
        {
          label: 'Active Topics',
          value: s.related_dossiers_count ?? 0,
          i18nKey: 'analytics.activeTopics',
        },
      ]
    case 'organization':
      return [
        {
          ...
          value: s.related_dossiers_count ?? 0,
          i18nKey: 'analytics.memberCountries',
        },
        {
          label: 'Open Work Items',
          value: s.pending_work_items ?? 0,
          i18nKey: 'analytics.openWorkItems',
        },
      ]
    case 'forum':
      return [
        {
          label: 'Sessions',
          value: s.upcoming_events_count ?? 0,
          i18nKey: 'analytics.sessionCount',
        },
        {
          label: 'Linked Dossiers',
          value: s.related_dossiers_count ?? 0,
          i18nKey: 'analytics.linkedDossiers',
        },
      ]
    case 'topic':
      return [
        {
          label: 'Connected Anchors',
          value: s.related_dossiers_count ?? 0,
          i18nKey: 'analytics.connectedAnchors',
        },
        {
          label: 'Open Work Items',
          value: s.pending_work_items ?? 0,
      ...
      return [
        {
          label: 'Members',
          value: s.related_dossiers_count ?? 0,
          i18nKey: 'analytics.memberCount',
        },
        {
          label: 'Deliverables',
          value: s.pending_work_items ?? 0,
          i18nKey: 'analytics.deliverableCount',
        },
      ]
    case 'person':
      return [
        {
          label: 'Interactions',
          value: s.recent_activities_count ?? 0,
          i18nKey: 'analytics.interactionCount',
        },
        {
          label: 'Affiliations',
          value: s.related_dossiers_count ?? 0,
          i18nKey: 'analytics.affiliationCount',
        },
      ]
      ...
      return [
        {
          label: 'Committees',
          value: s.related_dossiers_count ?? 0,
          i18nKey: 'analytics.committeeCount',
        },
        {
          label: 'Recent Activity',
          value: s.recent_activities_count ?? 0,
          i18nKey: 'analytics.recentActivity',
        },
      ]
    default:
      return []
