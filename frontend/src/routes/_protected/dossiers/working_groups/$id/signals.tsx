/**
 * Working Group Signals Tab Route
...
export const Route = createFileRoute('/_protected/dossiers/working_groups/$id/signals')({
  component: WorkingGroupSignalsRoute,
})

function WorkingGroupSignalsRoute(): ReactElement {
