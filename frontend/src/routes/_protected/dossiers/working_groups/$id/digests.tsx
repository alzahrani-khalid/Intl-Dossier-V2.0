/**
 * Working Group Digests Tab Route
...
export const Route = createFileRoute('/_protected/dossiers/working_groups/$id/digests')({
  component: WorkingGroupDigestsRoute,
})

function WorkingGroupDigestsRoute(): ReactElement {
