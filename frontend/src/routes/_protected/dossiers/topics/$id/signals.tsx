...
export const Route = createFileRoute('/_protected/dossiers/topics/$id/signals')({
  component: TopicSignalsRoute,
})

function TopicSignalsRoute(): ReactElement {
