...
export const Route = createFileRoute('/_protected/dossiers/topics/$id/digests')({
  component: TopicDigestsRoute,
})

function TopicDigestsRoute(): ReactElement {
