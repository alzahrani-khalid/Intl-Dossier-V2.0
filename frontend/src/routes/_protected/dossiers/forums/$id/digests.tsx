...
export const Route = createFileRoute('/_protected/dossiers/forums/$id/digests')({
  component: ForumDigestsRoute,
})

function ForumDigestsRoute(): ReactElement {
