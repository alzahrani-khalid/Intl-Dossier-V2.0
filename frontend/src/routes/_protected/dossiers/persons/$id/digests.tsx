...
export const Route = createFileRoute('/_protected/dossiers/persons/$id/digests')({
  component: PersonDigestsRoute,
})

function PersonDigestsRoute(): ReactElement {
