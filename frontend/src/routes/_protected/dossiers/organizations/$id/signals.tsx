/**
 * Organization Signals Tab Route
...
export const Route = createFileRoute('/_protected/dossiers/organizations/$id/signals')({
  component: OrganizationSignalsRoute,
})

function OrganizationSignalsRoute(): ReactElement {
