/**
 * Organization Digests Tab Route
...
export const Route = createFileRoute('/_protected/dossiers/organizations/$id/digests')({
  component: OrganizationDigestsRoute,
})

function OrganizationDigestsRoute(): ReactElement {
