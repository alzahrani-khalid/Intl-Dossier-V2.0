              ...
              <TableRow key={idx} className="min-h-11">
                ...
                <TableCell>
                  {committee.is_active ? (
                    ...
                    <Badge variant="secondary" className="text-muted-foreground rounded-full px-2 py-0.5 text-xs">
          ...
          <div key={idx} className="p-3 sm:p-4 rounded-lg border bg-card min-h-11">
            <div className="flex items-start justify-between gap-3 mb-1">
              ...
              {committee.is_active ? (
                ...
                <Badge variant="secondary" className="text-muted-foreground rounded-full px-2 py-0.5 text-xs flex-shrink-0">
                  {t('committees.inactive')}
                </Badge>
              )}
            </div>
