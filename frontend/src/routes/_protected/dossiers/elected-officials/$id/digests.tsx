/**
 * Elected Official Digests Tab Route
...
export const Route = createFileRoute('/_protected/dossiers/elected-officials/$id/digests')({
  component: ElectedOfficialDigestsRoute,
})

function ElectedOfficialDigestsRoute(): ReactElement {
