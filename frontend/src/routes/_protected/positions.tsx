...
export function PositionsLibraryPage() {
  ...
  const [typeFilter, setTypeFilter] = useState<PositionType | 'all'>(searchParams.type || 'all')
  const [sortBy, setSortBy] = useState(searchParams.sort || 'updated_at')
  const [_sortOrder, _setSortOrder] = useState(searchParams.order || 'desc')
  ...
  const { data, isLoading, error } = usePositions({
    ...
    thematic_category: typeFilter === 'all' ? undefined : typeFilter,
  })
                ...
                >
                  ...
                  <SelectContent>
                    ...
                    <SelectItem value="under_review">
                      {t('positions:status.under_review')}
                    </SelectItem>
