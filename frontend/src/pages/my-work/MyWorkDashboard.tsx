...
import type { WorkItemFilters, WorkSource, TrackingType, WorkItemSortBy, SortOrder } from '@/types/unified-work.types';
...
export default function MyWorkDashboard() {
  ...
  const { tab = 'all', filter, trackingType, search, sortBy = 'deadline', sortOrder = 'asc' } = searchParams;
