...
export function AssignmentDetailPage() {
  ...
  const [_showKanbanDialog, setShowKanbanDialog] = useState(false)
  ...
  const content = (
    <div className="container mx-auto space-y-6 p-6">
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
        ...
        <div className="space-y-6 lg:col-span-2">
          {/* Assignment Metadata */}
          <AssignmentMetadataCard assignment={assignment} assigneeName={assignment.assignee_name} />
 ...
 /> */}
              <div className="text-sm text-muted-foreground">
                {t('assignments.related_tasks.coming_soon', {
                  defaultValue: 'Related tasks list coming soon',
                })}
              </div>
            </div>
          )}
      ...
      <EscalateDialog
        ...
        onConfirm={async (_reason: string) => {
          // Escalation handled via dialog callback
