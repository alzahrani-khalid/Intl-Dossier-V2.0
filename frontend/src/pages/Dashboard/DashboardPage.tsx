  ...
  return (
    <div className="w-full space-y-6">
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            {alertItems.map((alert) => (
              <div key={alert.id} className="rounded-lg border border-warning/20 bg-warning/10 p-4">
                <div className="flex items-start justify-between gap-3">
                  <h3 className="text-sm font-semibold text-warning-foreground">{alert.title}</h3>
      ...
      <section className="grid gap-6 lg:grid-cols-3">
        {/* AI Engagement Recommendations Panel */}
              ...
              >
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-xs font-medium text-muted-foreground">
                    {t('dashboard.confidence', 'Confidence')}:{' '}
