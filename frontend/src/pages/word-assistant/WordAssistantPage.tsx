...
export function WordAssistantPage() {
  ...
  >({
    mutationFn: async ({
      ...
      const { data, error } = await supabase.functions.invoke<WordAssistantResponse>(
        'word-assistant',
        {
          body: payload,
        },
                ...
                <div className="space-y-4">
                  {messages.map((message) => (
                    ...
                    >
                      ...
                      <div
                        className={`max-w-[70%] ${message.role === 'user' ? 'order-1' : 'order-2'}`}
                      >
                        <Card
                          className={`${
