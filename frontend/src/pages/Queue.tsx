  ...
  return (
    <div className="container mx-auto px-4 py-8" dir={i18n.language === 'ar' ? 'rtl' : 'ltr'}>
      ...
      <div className="mb-6 flex items-start justify-between">
        ...
        >
          <svg className="me-2 size-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div>
            ...
            >
              ...
              <option value="engagement">
                {t('form.requestType.options.engagement', 'Engagement')}
              </option>
              <option value="position">{t('form.requestType.options.position', 'Position')}</option>
              <option value="mou_action">
                {t('form.requestType.options.mou_action', 'MOU Action')}
              </option>
              <option value="foresight">
                {t('form.requestType.options.foresight', 'Foresight')}
              </option>
            </select>
          </div>
