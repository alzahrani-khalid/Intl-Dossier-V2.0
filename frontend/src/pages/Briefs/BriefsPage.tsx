  ...
  const columns = [
    {
      ...
      cell: (brief: Brief) => <div className="font-mono text-sm">{brief.reference_number}</div>,
    },
    {
      key: 'title',
      ...
      cell: (brief: Brief) => (
        <div className={`${isRTL ? 'text-end' : 'text-start'}`}>
          <div className="font-medium">{isRTL ? brief.title_ar : brief.title_en}</div>
      ...
      cell: (brief: Brief) => (
        <div className="text-sm">
          ...
          {brief.related_organization && (
            <div>
              {isRTL ? brief.related_organization.name_ar : brief.related_organization.name_en}
            </div>
          )}
          {brief.related_event && (
