...
import { GastatFocalPointsCard } from './overview-cards/GastatFocalPointsCard'
...
export function OrganizationOverviewTab({
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6" dir={isRTL ? 'rtl' : 'ltr'}>
      <SharedSummaryStatsCard dossierId={dossierId} />
      <DossierAnalyticsCard dossierId={dossierId} dossierType="organization" />
      <MembershipStructureCard dossierId={dossierId} />
      <KeyRepresentativesCard dossierId={dossierId} />
      <GastatFocalPointsCard dossierId={dossierId} />
