...
export default function Themes() {
  ...
  // Query topics from unified dossiers table (type renamed from 'theme' to 'topic')
  const { data, isLoading, isError, error } = useDossiersByType('topic', 1, 1000)
          ...
          <thead>
            <tr className="bg-muted/50 text-start text-xs font-semibold uppercase tracking-wide text-muted-foreground">
              ...
              <th className="px-5 py-3 text-start">
                {t('themes.table.engagements', 'Engagements')}
              </th>
