                  ...
                  <CardContent className="space-y-6">
                    <div className="space-y-2">
                      ...
                      <div className="grid grid-cols-3 gap-4">
                        <Card
                          className={`cursor-pointer ${formData.theme === 'light' ? 'ring-2 ring-primary' : ''}`}
                        ...
                        <Card
                          className={`cursor-pointer ${formData.theme === 'dark' ? 'ring-2 ring-primary' : ''}`}
                        ...
                        <Card
                          className={`cursor-pointer ${formData.theme === 'auto' ? 'ring-2 ring-primary' : ''}`}
                          onClick={() => updateFormData({ theme: 'auto' })}
                        >
                          <CardContent className="p-4 text-center">
                            <Monitor className="h-8 w-8 mx-auto mb-2" />
                            <span className="text-sm">{t('settings.autoMode')}</span>
                          </CardContent>
                        </Card>
                      </div>
                    </div>
