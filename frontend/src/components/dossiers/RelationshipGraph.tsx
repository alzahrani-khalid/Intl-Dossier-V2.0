...
export function RelationshipGraph({
  ...
  const { nodes: initialNodes, edges: initialEdges } = useMemo(() => {
    ...
    relationships.forEach((rel, index) => {
      ...
      if (
        rel.target_dossier &&
        rel.target_dossier.id !== dossierId &&
        !nodeMap.has(rel.target_dossier.id)
      ) {
        nodes.push({
      ...
      if (
        rel.source_dossier &&
        rel.source_dossier.id !== dossierId &&
        !nodeMap.has(rel.source_dossier.id)
      ) {
        nodes.push({
        ...
        <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 items-start sm:items-center">
          ...
          >
            ...
            <SelectContent>
              ...
              <SelectItem value="participates_in">
                {t('relationships.types.participates_in')}
              </SelectItem>
              <SelectItem value="collaborates_with">
                {t('relationships.types.collaborates_with')}
              </SelectItem>
