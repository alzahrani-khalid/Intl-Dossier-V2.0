      ...
      <Card>
        ...
        <CardContent className="space-y-3">
          ...
          <div>
            ...
            <Card className="mt-1 border-s-4 border-s-blue-500">
          ...
          <CardContent className="space-y-3">
            {changes.length === 0 ? (
              <Alert>
                ...
                <AlertDescription>{t('afterActions.editFlow.noChanges')}</AlertDescription>
              </Alert>
            ) : (
      ...
      {action === 'approve' && (
        <Card className="border-green-500">
          ...
          <CardContent className="space-y-4">
            ...
            <Alert>
              <AlertCircle className="size-4" />
              <AlertDescription>{t('afterActions.editFlow.approvalWarning')}</AlertDescription>
            </Alert>
      ...
      {action === 'reject' && (
        <Card className="border-red-500">
          ...
          <CardContent className="space-y-4">
            ...
            <Alert variant="destructive">
              <AlertCircle className="size-4" />
              <AlertDescription>{t('afterActions.editFlow.rejectionWarning')}</AlertDescription>
            </Alert>
