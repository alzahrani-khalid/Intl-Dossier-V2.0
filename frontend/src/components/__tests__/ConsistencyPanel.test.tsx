...
describe('ConsistencyPanel', () => {
  ...
  it('calls onResolveConflict when action buttons are clicked', () => {
    ...
    expect(onResolveConflict).toHaveBeenCalledWith('123e4567-e89b-12d3-a456-426614174002', 'modify')
  })
  ...
  it('calls onViewConflictingPosition when view button is clicked', () => {
    ...
    expect(onViewConflictingPosition).toHaveBeenCalledWith('123e4567-e89b-12d3-a456-426614174002')
  })
