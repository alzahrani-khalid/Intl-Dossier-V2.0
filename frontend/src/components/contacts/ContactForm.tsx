...
export function ContactForm({
    ...
    return (
      <TooltipProvider>
        <Tooltip>
          ...
          <TooltipContent>
            <p>
              {t('contactDirectory.ocr.confidence_tooltip', { confidence: Math.round(confidence) })}
            </p>
          </TooltipContent>
        </Tooltip>
      </TooltipProvider>
  ...
  const form = useForm<FormValues>({
    defaultValues: {
      ...
      source_type:
        (defaultValues?.metadata?.source_type as 'manual' | 'business_card' | 'document') ||
        'manual',
    },
  })
      ...
      >
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              <FormLabel className="text-sm sm:text-base">
                {t('contactDirectory.form.organization')}
              </FormLabel>
        ...
        <div className="flex flex-col-reverse gap-3 pt-4 sm:flex-row sm:justify-end">
          ...
          <Button type="submit" disabled={isSubmitting} className="h-11 px-6 sm:h-10">
            ...
            {mode === 'create'
              ...
              : t('contactDirectory.form.save_changes')}
          </Button>
        </div>
      </form>
    </Form>
