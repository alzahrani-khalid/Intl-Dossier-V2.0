...
export function MFAManagement({ className }: MFAManagementProps) {
  ...
  const disableMFA = (useAuthStore() as any).disableMFA as
    ...
    | undefined
  const generateBackupCodes = (useAuthStore() as any).generateBackupCodes as
    | (() => Promise<string[]>)
    | undefined
  ...
  const handleDisableMFA = async () => {
    try {
      // TODO: Collect password from user via a confirmation dialog
      await disableMFA?.('')
            ...
            <div className="flex items-start gap-2">
              ...
              <div className="space-y-2">
                ...
                <div className="flex gap-2">
                  ...
                  <Button size="sm" variant="outline" onClick={() => setShowDisableConfirm(false)}>
                    Cancel
                  </Button>
                </div>
              </div>
