    ...
    <span>
      {parts.map((part) => (
        <span
          ...
          className={cn(part.isMatch && 'bg-warning/20 font-medium rounded px-0.5')}
        >
          {part.text}
        </span>
      ))}
  ...
  return (
    ...
    >
      <SuggestionIcon
        ...
        className={cn(
          'flex-shrink-0',
          suggestionType === 'history' && 'text-ink-faint',
          suggestionType === 'popular' && 'text-warning',
          suggestionType === 'tag' && 'text-info',
          suggestionType === 'title' && 'text-success',
        )}
      />
