    ...
    return (
      <Card className="mx-auto w-full max-w-md">
        <CardHeader>
          ...
          <CardDescription>Use one of your saved backup codes to sign in</CardDescription>
        </CardHeader>
          ...
          <div className="rounded-lg border border-yellow-200 bg-yellow-50 p-3 dark:border-yellow-800 dark:bg-yellow-900/20">
            <div className="flex items-start gap-2">
              ...
              <div className="text-sm text-yellow-800 dark:text-yellow-200">
                ...
                <p>
                  Each backup code can only be used once. After use, it will be removed from your
                  account.
                </p>
              </div>
            </div>
  ...
  return (
    <Card className="mx-auto w-full max-w-md">
      ...
      <CardContent className="space-y-4">
        ...
        <div className="text-center">
          <Button variant="link" size="sm" onClick={toggleMode} className="text-sm">
