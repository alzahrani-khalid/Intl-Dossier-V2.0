...
const confidenceConfig: Record<
  ConfidenceLevel,
  { color: string; icon: typeof HelpCircle; textColor: string }
> = {
  unconfirmed: {
  ...
  const validateMutation = useMutation({
    ...
    onSuccess: () => {
      ...
      toast({
        ...
        description: t('dossiers.intelligence.validation.success_description', {
          level: nextConfidence,
        }),
      })
    ...
    <Card className="w-full" dir={isRTL ? 'rtl' : 'ltr'}>
      ...
      <CardContent className="space-y-4">
        ...
        <div className="space-y-2">
          ...
          <Badge
            className={`${confidenceConfig[currentConfidence].color} flex items-center gap-2 w-fit`}
          >
