...
import { UserPlus, Mail, Phone, Building2, Calendar, Edit, Trash2, User } from 'lucide-react'
      ...
      <Card>
        ...
        <CardContent>
          <div className="flex flex-col items-center justify-center py-8 text-center">
            ...
            {onAddContact && (
              <Button variant="outline" size="sm" onClick={onAddContact} className="mt-4 gap-2">
                <UserPlus className="size-4" />
                ...
                {contact.last_interaction_date && (
                  <div className="flex items-center gap-2 border-t pt-2 text-xs text-muted-foreground">
                    ...
                    <span>
                      ...
                      {new Date(contact.last_interaction_date).toLocaleDateString(i18n.language, {
                        year: 'numeric',
                        month: 'short',
                        day: 'numeric',
                      })}
