    ...
    <>
      ...
      >
          ...
          >
            ...
            {isDeleted && canRestore && onRestore && (
              ...
              >
                ...
                <span className="text-xs sm:text-sm">{t('entityLinks.restore')}</span>
              </Button>
            )}
          </div>
        </CardHeader>
        ...
        {(link.notes || isEditing) && (
          <CardContent className={cn('px-3 py-0 pb-3 sm:px-4 sm:pb-4', 'pt-0')}>
            {isEditing ? (
              <div className="space-y-2">
                ...
                >
                  <span className="text-start">{notesValue.length}/1000</span>
      ...
      <AlertDialog open={showDeleteDialog} onOpenChange={setShowDeleteDialog}>
        <AlertDialogContent className={cn('max-w-md mx-4 sm:mx-auto', isRTL && 'text-end')}>
          <AlertDialogHeader>
