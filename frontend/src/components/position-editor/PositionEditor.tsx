  ...
  const handleScroll = (source: 'en' | 'ar') => (e: React.UIEvent<HTMLDivElement>) => {
    ...
    if (otherRef.current) {
      const otherScrollTop =
        scrollPercentage * (otherRef.current.scrollHeight - otherRef.current.clientHeight)
  ...
  return (
    <div className={cn('space-y-4', className)}>
      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
        ...
        <Card>
          <CardHeader>
            <CardTitle className="text-sm font-medium">{t('editor.englishContent')}</CardTitle>
          </CardHeader>
        ...
        <Card>
          <CardHeader>
            <CardTitle className="text-sm font-medium">{t('editor.arabicContent')}</CardTitle>
          </CardHeader>
          <CardContent className="space-y-2">
            <div>
      ...
      {initialData?.id && (
        <Card className="mt-6">
          <CardHeader>
            <CardTitle className="text-sm font-medium">{t('editor.linkedDossiers')}</CardTitle>
          </CardHeader>
          <CardContent>
