          ...
          <div className="space-y-2">
            ...
            <div className="flex gap-2">
              {isOnline && pendingActions.length > 0 && (
                <Button size="sm" onClick={processQueue} className="text-xs">
              ...
              {failedActions.length > 0 && (
                <Button size="sm" variant="outline" onClick={retryFailed} className="text-xs">
                  Retry Failed
                </Button>
              )}

              {completedActions.length > 0 && (
                <Button size="sm" variant="ghost" onClick={clearCompleted} className="text-xs">
                  Clear
                </Button>
              )}
            </div>
