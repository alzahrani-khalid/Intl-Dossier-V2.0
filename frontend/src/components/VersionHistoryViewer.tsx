          ...
          <div className="space-y-3">
            {changes.length === 0 ? (
              <Alert>
                ...
                <AlertDescription>{t('afterActions.versions.noChanges')}</AlertDescription>
              </Alert>
            ) : (
    ...
    <Dialog open={open} onOpenChange={handleOpenChange}>
      ...
      <DialogContent className="max-h-[80vh] max-w-3xl overflow-y-auto" dir={isRTL ? 'rtl' : 'ltr'}>
        <DialogHeader>
          ...
          <DialogDescription>{t('afterActions.versions.description')}</DialogDescription>
        </DialogHeader>
        ...
        <div className="space-y-4">
          ...
          {!loading && !error && versions.length === 0 && (
            <Alert>
              <AlertCircle className="size-4" />
              <AlertDescription>{t('afterActions.versions.noVersions')}</AlertDescription>
            </Alert>
          )}
