  ...
  return (
    <button
      ...
      className={cn(
        ...
        'hover:bg-accent',
        'focus:outline-none',
        compact ? 'w-16 h-[30px] p-[3px]' : 'w-24 sm:w-28 h-[30px] p-[3px]',
      )}
    ...
    >
      ...
      <div
        className={cn(
          'absolute rounded-md transition-all duration-300 ease-in-out',
          'bg-primary shadow-md',
          'flex items-center justify-center',
          compact ? 'h-[22px] w-7 top-[3px]' : 'h-[22px] w-10 top-[3px]',
          isRTL ? 'end-[3px]' : 'start-[3px]',
        )}
      />
