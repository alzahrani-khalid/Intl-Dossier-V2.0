...
export function DelegationChainVisualization({
  ...
  if (chains.length === 0) {
    return (
      <Alert>
        ...
        <AlertDescription className="text-start ms-2">{t('delegation.noChains')}</AlertDescription>
      </Alert>
    )
  }

  // Group chains by grantor
  const chainsByGrantor = chains.reduce(
    (acc, chain) => {
  ...
  return (
    <div className="container mx-auto px-4 sm:px-6 lg:px-8 space-y-4" dir={isRTL ? 'rtl' : 'ltr'}>
                      ...
                      >
                        ...
                        <div className="flex items-center gap-2 sm:gap-3 flex-1 min-w-0">
                          ...
                          <div className="flex items-center gap-2 flex-shrink-0">
                            ...
                            <span className="text-sm font-medium truncate">{grantor.username}</span>
                          </div>
