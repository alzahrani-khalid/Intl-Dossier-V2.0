  ...
  .refine(
    (data) => {
      ...
      if (
        ...
        (!data.allowed_resources || data.allowed_resources.length === 0)
      ) {
        return false
      }
      return true
...
export function UserProfileForm({ onSuccess }: UserProfileFormProps) {
  ...
  const form = useForm<UserProfileFormData, unknown, UserProfileFormData>({
  ...
  return (
    <div className="w-full max-w-2xl mx-auto px-4 sm:px-6" dir={isRTL ? 'rtl' : 'ltr'}>
      <Form {...form}>
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormDescription className="text-xs sm:text-sm">
                  {t(
                    'user_management.email_description',
                    'User will receive activation email at this address',
                  )}
                </FormDescription>
                <FormMessage />
              </FormItem>
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormDescription className="text-xs sm:text-sm">
                  {t(
                    'user_management.username_description',
              ...
              <FormItem>
                ...
                >
                  <FormControl>
                    <SelectTrigger className="h-11 sm:h-10 px-4 text-base sm:text-sm">
                      <SelectValue
                        placeholder={t('user_management.select_user_type', 'Select account type')}
                      />
                    </SelectTrigger>
                  </FormControl>
                  <SelectContent>
                ...
                <FormDescription className="text-xs sm:text-sm">
                  {t(
                    'user_management.user_type_description',
                    'Employee accounts have permanent access, guest accounts expire',
                  )}
                </FormDescription>
                <FormMessage />
              </FormItem>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem className="flex flex-col">
                  ...
                  <FormDescription className="text-xs sm:text-sm">
                    {t(
                      'user_management.expires_at_description',
                      'Guest account will be automatically deactivated on this date',
                    )}
                  </FormDescription>
                  <FormMessage />
                </FormItem>
