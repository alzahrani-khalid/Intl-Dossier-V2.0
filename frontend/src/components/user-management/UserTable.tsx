...
export function UserTable({ users, isLoading }: UserTableProps) {
  ...
  const getRoleBadge = (role: User['role']) => {
    const variants = {
      ...
      editor: {
        icon: UserIcon,
        label: t('userManagement.roles.editor'),
        className: 'bg-blue-100 text-blue-800',
      },
      viewer: {
        icon: UserIcon,
        label: t('userManagement.roles.viewer'),
          ...
          <div className="flex flex-col gap-4 py-2">
            <div className="flex flex-col gap-2">
              ...
              <Textarea
                ...
                onChange={(e) =>
                  setDeactivateDialog({ ...deactivateDialog, reason: e.target.value })
                }
            ...
            {deactivateDialog.orphanedItems && (
              <div className="p-3 bg-yellow-50 border border-yellow-200 rounded-lg text-sm">
                <p className="font-semibold mb-2">
                  {t('userManagement.deactivation.orphanedItems')}
                </p>
                <ul className="list-disc list-inside text-xs space-y-1">
                  <li>
                    {t('userManagement.deactivation.dossiers', {
                      count: deactivateDialog.orphanedItems.dossiers,
                    })}
                  </li>
                  <li>
                    {t('userManagement.deactivation.delegations', {
                      count: deactivateDialog.orphanedItems.delegations,
                    })}
                  </li>
                  <li>
                    {t('userManagement.deactivation.approvals', {
                      count: deactivateDialog.orphanedItems.approvals,
                    })}
                  </li>
                </ul>
              </div>
          ...
          <div className="flex flex-col gap-4 py-2">
              ...
              <div className="flex flex-col gap-2">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setReactivateDialog({
                      ...reactivateDialog,
                      securityReviewApproval: e.target.value,
                    })
                  }
            ...
            <div className="flex flex-col gap-2">
              ...
              <Textarea
                ...
                onChange={(e) =>
                  setReactivateDialog({ ...reactivateDialog, reason: e.target.value })
                }
