...
export function AnimatedSidebar() {
  ...
  // MY WORK - personal productivity (no badge counts)
  const myWorkItems = useMemo<NavigationItem[]>(
    () => [
      {
        id: 'my-work-list',
        label: t('navigation.listView', 'List View'),
        path: '/my-work',
        icon: LayoutDashboard,
      },
      {
        id: 'my-work-board',
        label: t('navigation.boardView', 'Board View'),
        path: '/my-work/board',
        icon: ListChecks,
      },
    ],
  ...
  // REQUESTS - queue management (with badge counts)
  const requestItems = useMemo<NavigationItem[]>(
    () => [
      {
        id: 'incoming-requests',
        label: t('navigation.incomingRequests', 'Incoming Requests'),
        path: '/my-work/intake',
        icon: Inbox,
      ...
      },
      {
        ...
        label: t('navigation.awaitingResponse', 'Awaiting Response'),
  ...
  return (
    <Sidebar collapsible="icon" side={isRTL ? 'right' : 'left'} dir={isRTL ? 'rtl' : 'ltr'}>
      ...
      <SidebarContent>
        {/* My Work Section - Personal Productivity */}
        <SidebarGroup>
        ...
        {/* Requests Section - Queue Management */}
        <SidebarGroup>
          <SidebarGroupLabel>{t('navigation.requests', 'Requests')}</SidebarGroupLabel>
          <SidebarGroupContent>
            <SidebarMenu>
              {isLoadingCounts
                ? [0, 1].map((n) => (
