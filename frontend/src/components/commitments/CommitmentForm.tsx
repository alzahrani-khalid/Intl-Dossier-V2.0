    ...
    <Form {...form}>
      ...
      >
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              <FormLabel className="text-start block">{t('form.title')} *</FormLabel>
              <FormControl>
                <Input {...field} placeholder={t('form.titlePlaceholder')} className="min-h-11" />
              </FormControl>
              <FormMessage>
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              <FormLabel className="text-start block">{t('form.description')} *</FormLabel>
              <FormControl>
                <Textarea
                  {...field}
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem className="flex flex-col">
              <FormLabel className="text-start">{t('form.dueDate')} *</FormLabel>
              <Popover>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel className="text-start block">{t('form.ownerType')}</FormLabel>
                <Select onValueChange={field.onChange} defaultValue={field.value}>
                  <FormControl>
                    <SelectTrigger className="min-h-11">
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              <FormLabel className="text-start block">{t('form.trackingMode')}</FormLabel>
              <Select onValueChange={field.onChange} defaultValue={field.value}>
                <FormControl>
                  <SelectTrigger className="min-h-11">
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem className="flex flex-row items-center justify-between rounded-lg border p-4">
              ...
              <FormControl>
                <Switch checked={field.value} onCheckedChange={field.onChange} className="ms-4" />
              </FormControl>
            </FormItem>
          )}
        />
