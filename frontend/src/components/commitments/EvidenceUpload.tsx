      ...
      {!selectedFile && (
        <>
          ...
          >
            ...
            <p className="text-sm sm:text-base font-medium mb-1">{t('evidence.dropzone')}</p>
            <p className="text-xs sm:text-sm text-muted-foreground">{t('evidence.allowedTypes')}</p>
            <p className="text-xs text-muted-foreground mt-1">{t('evidence.maxSize')}</p>
          </div>
