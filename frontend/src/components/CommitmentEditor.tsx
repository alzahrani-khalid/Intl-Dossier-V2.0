...
const priorities: Commitment['priority'][] = ['low', 'medium', 'high', 'urgent']
const statuses: NonNullable<Commitment['status']>[] = [
  'pending',
  'in_progress',
  'completed',
  'cancelled',
            ...
            <div className={cn('flex items-center justify-between', isRTL && 'flex-row-reverse')}>
              ...
              <div className={cn('flex items-center gap-2', isRTL && 'flex-row-reverse')}>
                ...
                {commitment.ai_confidence !== undefined && (
                  <Badge
                    variant={
                      commitment.ai_confidence >= 0.8
                        ? 'default'
                        : commitment.ai_confidence >= 0.5
                          ? 'secondary'
                          : 'destructive'
                    }
                  >
          ...
          <CardContent className="space-y-4">
            ...
            <div>
              ...
              <RadioGroup
                ...
                onValueChange={(value) =>
                  updateCommitment(index, 'owner_type', value as 'internal' | 'external')
                }
                disabled={readOnly}
            ...
            <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
              <div>
                <Label htmlFor={`priority-${index}`}>
                  {t('afterActions.commitments.priority')} *
                </Label>
                <Select
