    ...
    <div className="w-full bg-white font-sans dark:bg-neutral-950 md:px-10" ref={containerRef}>
      ...
      <div ref={ref} className="relative mx-auto max-w-7xl pb-20">
        {data.map((item, index) => (
          <div key={index} className="flex justify-start pt-10 md:gap-10 md:pt-40">
            <div className="sticky top-40 z-40 flex max-w-xs flex-col items-center self-start md:w-full md:flex-row lg:max-w-sm">
              <div className="absolute start-3 flex size-10 items-center justify-center rounded-full bg-white dark:bg-black md:start-3">
              ...
              <h3 className="hidden text-xl font-bold text-neutral-500 dark:text-neutral-500 md:block md:ps-20 md:text-5xl ">
                {item.title}
              </h3>
            </div>

            <div className="relative w-full pe-4 ps-20 md:ps-4">
              <h3 className="mb-4 block text-start text-2xl font-bold text-neutral-500 dark:text-neutral-500 md:hidden">
                {item.title}
              </h3>
              {item.content}{' '}
            </div>
        ...
        <div
          ...
          className="absolute start-8 top-0 w-[2px] overflow-hidden bg-[linear-gradient(to_bottom,var(--tw-gradient-stops))] from-transparent from-0% via-neutral-200 to-transparent to-[99%] [mask-image:linear-gradient(to_bottom,transparent_0%,black_10%,black_90%,transparent_100%)] dark:via-neutral-700  md:start-8 "
        >
          <motion.div
            style={{
