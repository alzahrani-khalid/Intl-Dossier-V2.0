  ...
  ({ className, ...props }, ref) => {
    ...
    return (
      <button
        ...
        {...props}
      >
        <span className="relative z-10 flex size-5 items-center justify-center rounded-full border border-sidebar-border bg-background text-sidebar-foreground shadow-sm">
