...
export function PlaceholdersAndVanishInput({
  ...
  return (
    ...
    >
      <canvas
        className={cn(
          'absolute pointer-events-none  text-base transform scale-50 top-[20%] start-2 sm:start-8 origin-top-left filter invert dark:invert-0 pe-20',
      ...
      <input
        ...
        type="text"
        className={cn(
          'w-full relative text-sm sm:text-base z-50 border-none dark:text-white bg-transparent text-black h-full rounded-full focus:outline-none focus:ring-0 ps-4 sm:ps-10 pe-20',
