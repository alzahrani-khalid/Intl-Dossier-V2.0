    ...
    <div className={cn('w-full', className)}>
      ...
      <div className="relative">
              ...
              <React.Fragment key={stage.order}>
                ...
                <div className="flex min-w-[180px] shrink-0 flex-col items-center">
                  ...
                  <div className="mb-3 flex flex-col items-center">
                    <div
                      className={cn(
                        ...
                        stageStatus === 'completed' && 'bg-success/10 border-success text-success',
                        stageStatus === 'current' &&
                          'bg-accent/10 border-accent text-accent ring-4 ring-accent/10',
                        stageStatus === 'pending' && 'bg-muted border-muted text-ink-mute',
                      )}
                      role="img"
                  ...
                  <div className="w-full space-y-2 text-center">
                    {/* Role */}
                    <div className="break-words text-sm font-medium">{stage.role}</div>
                      ...
                      <div className="space-y-2">
                          ...
                          <TooltipProvider>
                            <Tooltip>
                              <TooltipTrigger asChild>
                                <Badge
                                  variant="outline"
                                  className="gap-1 border-success text-xs text-success"
                                >
                              ...
                              <TooltipContent>
                                <p>
                                  {t('approval.delegatedFrom', {
                                    name:
                                      lastApproval.delegated_from_name ||
                                      lastApproval.delegated_from,
                                  })}
                                </p>
                        ...
                        {lastApproval.reassigned_by && (
                          <TooltipProvider>
                            <Tooltip>
                              <TooltipTrigger asChild>
                                <div className="flex items-center justify-center gap-1 text-xs text-secondary-foreground">
                                  <Users className="size-3" />
                              ...
                              <TooltipContent>
                                <p>
                                  {t('approval.reassignedBy', {
                                    name:
                                      lastApproval.reassigned_by_name || lastApproval.reassigned_by,
                                  })}
                                </p>
        ...
        <div className="relative mt-4 h-1 overflow-hidden rounded-full bg-muted">
          <div
            className="absolute top-0 h-full rounded-full bg-accent transition-all duration-500 ease-out"
            style={{
