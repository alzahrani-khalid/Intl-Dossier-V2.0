      ...
      <DialogContent className="max-w-md" aria-describedby="step-up-description">
        <DialogHeader>
          <DialogTitle className="flex items-center gap-2">
            <Shield className="size-5 text-warning" aria-hidden="true" />
            <span>{t('stepUp.title')}</span>
          </DialogTitle>
          <DialogDescription id="step-up-description">{t('stepUp.description')}</DialogDescription>
        </DialogHeader>
        ...
        {isInitiating && (
          <div className="flex items-center justify-center py-8">
            ...
            <span className="ms-3 text-sm text-muted-foreground">{t('stepUp.initiating')}</span>
          </div>
        )}
          ...
          <form onSubmit={verifyCode} className="space-y-4">
            ...
            <div className="flex items-center justify-between rounded-md bg-muted p-3">
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm font-medium">{getChallengeTypeLabel()}</span>
              </div>
            ...
            {(challengeData.challenge_type === 'sms' ||
              challengeData.challenge_type === 'push') && (
              <Button
                type="button"
                variant="ghost"
                size="sm"
              ...
              >
                <RefreshCw
                  className={`me-2 size-4 ${isResending ? 'animate-spin' : ''}`}
                  aria-hidden="true"
                />
        ...
        <div className="border-t pt-4">
          <p className="text-center text-xs text-muted-foreground">{t('stepUp.helpText')}</p>
        </div>
      </DialogContent>
    </Dialog>
  )
