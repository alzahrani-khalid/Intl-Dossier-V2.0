  ...
  return (
    <div className="space-y-4">
      <FormField
        ...
        render={({ field }) => (
          <FormItem>
            <FormLabel>{t('dossier:form.topic.category')} <span className="text-destructive">*</span></FormLabel>
            <Select onValueChange={field.onChange} defaultValue={field.value}>
              ...
              <SelectContent>
                ...
                <SelectItem value="technical">{t('dossier:form.topic.categories.technical')}</SelectItem>
                <SelectItem value="strategic">{t('dossier:form.topic.categories.strategic')}</SelectItem>
                <SelectItem value="operational">{t('dossier:form.topic.categories.operational')}</SelectItem>
              </SelectContent>
            </Select>
