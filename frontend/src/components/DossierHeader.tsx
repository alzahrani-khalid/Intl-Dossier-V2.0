...
export function DossierHeader({ dossier, onEdit, onArchive, onGenerateBrief }: DossierHeaderProps) {
      ...
      <div className="flex flex-col gap-4 p-6">
        ...
        <div className="flex items-start justify-between gap-4">
          <div className="min-w-0 flex-1">
            <h1 className="mb-2 truncate text-3xl font-bold tracking-tight">{name}</h1>
