...
interface AppearanceSettingsSectionProps {
   ...
   * (D-10 preserves the per-section form). The design controls in this
 ...
 *
 * Renders the mode + density design-system axes as direct bindings to
 * DesignProvider hooks (the same hooks the Phase 34 TweaksDrawer uses, so
 * state never diverges between the two surfaces).
 *
...
export function AppearanceSettingsSection(
  _props: AppearanceSettingsSectionProps,
): React.JSX.Element {
