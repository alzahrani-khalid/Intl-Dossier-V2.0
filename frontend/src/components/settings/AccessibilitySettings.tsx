    ...
    <div style={{ padding: 12 }}>
      ...
      <label>
        <input
          ...
          onChange={(e) => update({ large_text: e.target.checked })}
        />{' '}
        Large text
      </label>
      <br />
      ...
      <label>
        <input
          type="checkbox"
          checked={prefs.screen_reader}
          onChange={(e) => update({ screen_reader: e.target.checked })}
        />{' '}
      ...
      <label>
        <input
          ...
          onChange={(e) => update({ keyboard_only: e.target.checked })}
        />{' '}
      ...
      <label>
        ...
        <select
          ...
          onChange={(e) => update({ focus_indicators: e.target.value as any })}
        >
