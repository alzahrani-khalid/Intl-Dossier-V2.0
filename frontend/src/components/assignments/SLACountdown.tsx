...
export function SLACountdown({ sla }: SLACountdownProps): JSX.Element {
  ...
  const getIcon = (health: HealthStatus): JSX.Element => {
    switch (health) {
      case 'safe':
    ...
    <Card dir={isRTL ? 'rtl' : 'ltr'}>
      ...
      <CardContent className="space-y-4">
        <div className="flex items-center justify-between">
          <span className="text-sm text-muted-foreground">{t('sla.health', { defaultValue: 'Status' })}:</span>
        ...
        <div className="space-y-2">
          <div className="flex items-center justify-between">
            <span className="text-sm text-muted-foreground">{t('sla.remaining', { defaultValue: 'Time Remaining' })}:</span>
        ...
        <div className="flex items-center justify-between">
          <span className="text-sm text-muted-foreground">{t('sla.percentage', { defaultValue: 'Progress' })}:</span>
