...
export function EngagementContextBanner({
  ...
  onShowKanban,
}: EngagementContextBannerProps): React.JSX.Element {
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-2">
            <div className="flex items-center justify-between text-sm">
              <span className="text-muted-foreground">{t('engagement.progress')}:</span>
              <span className="font-medium">
                {Math.round(progressPercentage)}% ({completedAssignments}/{totalAssignments}{' '}
                {t('engagement.tasksCompleted')})
              </span>
            </div>
