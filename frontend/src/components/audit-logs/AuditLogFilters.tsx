...
> = {
  INSERT: { icon: Plus, label_en: 'Created', label_ar: 'إنشاء', color: 'text-success' },
  UPDATE: { icon: Edit3, label_en: 'Updated', label_ar: 'تحديث', color: 'text-info' },
  DELETE: { icon: Trash2, label_en: 'Deleted', label_ar: 'حذف', color: 'text-danger' },
}
