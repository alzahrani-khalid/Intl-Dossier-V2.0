...
export function CreateDossierDialog({ open, onOpenChange }: CreateDossierDialogProps) {
  ...
  const [formData, setFormData] = useState<DossierCreate>({
    ...
    name_ar: '',
    type: 'country',
    sensitivity_level: 1 as SensitivityLevel,
    summary_en: '',
    summary_ar: '',
    tags: [],
  })
      ...
      <DialogContent className="max-h-[90vh] max-w-2xl overflow-y-auto">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="space-y-2">
            ...
            <Select
              value={formData.type}
              onValueChange={(value: DossierType) => setFormData({ ...formData, type: value })}
            >
              ...
              <SelectContent>
                ...
                <SelectItem value="topic">{t('types.topic')}</SelectItem>
              </SelectContent>
            </Select>
          </div>
          ...
          <div className="space-y-2">
            ...
            <Select
              value={String(formData.sensitivity_level ?? 1)}
              onValueChange={(value) =>
                setFormData({ ...formData, sensitivity_level: Number(value) as SensitivityLevel })
              }
            >
              ...
              <SelectContent>
                <SelectItem value="1">{t('sensitivity.low')}</SelectItem>
                <SelectItem value="2">{t('sensitivity.medium')}</SelectItem>
                <SelectItem value="3">{t('sensitivity.high')}</SelectItem>
              </SelectContent>
            </Select>
          </div>
