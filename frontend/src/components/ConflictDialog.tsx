...
export function ConflictDialog({
 ...
 const getConflictingFields = (): Array<{
   ...
   const conflicts: Array<{ field: string; currentValue: JsonValue; remoteValue: JsonValue }> = [];
   ...
   allKeys.forEach((key) => {
     ...
     if (isDifferent) {
       conflicts.push({
         field: key,
         currentValue: currentValue as JsonValue,
         remoteValue: remoteValue as JsonValue,
       });
     }
   });
