...
import { cc as g, b9 as k, aS as B } from './vendor-misc-BiJvMP0A.js'
...
function A() {
  const { t, i18n: y } = w('dossier'),
    ...
    [o, f] = b.useState(1),
    x = 20,
    { data: r, isLoading: h, error: u } = L('country', o, x),
    i = r?.data.filter((s) => {
      if (!a) return !0
              ...
              e.jsxs('div', {
                children: [
                  e.jsx('h1', {
                    ...
                    children: t('type.country'),
                  }),
                  e.jsx('p', {
                    className: 'text-sm sm:text-base text-muted-foreground mt-1',
                    children: t('typeDescription.country'),
                  }),
                ],
              }),
            ],
...
//# sourceMappingURL=index-DQwB7ZWL.js.map
