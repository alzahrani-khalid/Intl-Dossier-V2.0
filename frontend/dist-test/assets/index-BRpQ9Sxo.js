...
import { bn as g, b9 as k, aS as S } from './vendor-misc-BiJvMP0A.js'
...
function q() {
  const { t, i18n: y } = w('dossier'),
    ...
    [o, f] = b.useState(1),
    x = 20,
    { data: r, isLoading: h, error: u } = L('forum', o, x),
    i = r?.data.filter((s) => {
      if (!a) return !0
    ...
    children: [
      ...
      h &&
        e.jsxs('div', {
          ...
          children: [
            e.jsx(S, { className: 'h-8 w-8 sm:h-10 sm:w-10 animate-spin text-muted-foreground' }),
            e.jsx('span', {
...
//# sourceMappingURL=index-BRpQ9Sxo.js.map
