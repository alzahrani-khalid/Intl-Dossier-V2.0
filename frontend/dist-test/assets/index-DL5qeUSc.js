...
import { aI as g, b9 as k, aS as B } from './vendor-misc-BiJvMP0A.js'
...
function U() {
  const { t, i18n: y } = w('dossier'),
    ...
    [o, f] = b.useState(1),
    x = 20,
    { data: r, isLoading: h, error: p } = L('person', o, x),
    i = r?.data.filter((s) => {
      if (!a) return !0
...
//# sourceMappingURL=index-DL5qeUSc.js.map
