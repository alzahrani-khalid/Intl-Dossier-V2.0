...
import { u as _ } from './useDossier-CiPcwRKl.js'
import {
  B as l,
  I as L,
  N as C,
...
import { bC as v, b9 as $, aS as B } from './vendor-misc-BiJvMP0A.js'
...
function A() {
  const { t, i18n: y } = w('dossier'),
    ...
    [o, g] = f.useState(1),
    x = 20,
    { data: r, isLoading: h, error: u } = _('working_group', o, x),
    i = r?.data.filter((s) => {
      if (!a) return !0
      ...
      e.jsxs('header', {
        ...
        children: [
              ...
              e.jsxs('div', {
                children: [
                  e.jsx('h1', {
                    ...
                    children: t('type.working_group'),
                  }),
                  e.jsx('p', {
                    className: 'text-sm sm:text-base text-muted-foreground mt-1',
                    children: t('typeDescription.working_group'),
                  }),
                ],
              }),
            ],
          ...
          e.jsx(l, {
            ...
            children: e.jsxs(n, {
              to: '/dossiers/create',
              children: [e.jsx($, { className: 'h-4 w-4 me-2' }), t('action.create')],
            }),
          }),
        ],
      }),
...
//# sourceMappingURL=index-Gt4f0-Ce.js.map
