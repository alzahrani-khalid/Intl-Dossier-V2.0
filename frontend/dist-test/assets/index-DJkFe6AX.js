import { u as w, r as g, j as e } from './react-vendor-Buoak6m3.js'
import { L as n } from './tanstack-vendor-BZC-rs5U.js'
...
import { aJ as v, b9 as k, aS as z } from './vendor-misc-BiJvMP0A.js'
...
function O() {
  const { t, i18n: y } = w('dossier'),
    ...
    [o, f] = g.useState(1),
    x = 20,
    { data: i, isLoading: h, error: u } = L('organization', o, x),
    r = i?.data.filter((s) => {
      if (!a) return !0
    ...
    children: [
              ...
              e.jsxs('div', {
                children: [
                  e.jsx('h1', {
                    ...
                    children: t('type.organization'),
                  }),
                  e.jsx('p', {
                    className: 'text-sm sm:text-base text-muted-foreground mt-1',
                    children: t('typeDescription.organization'),
                  }),
                ],
              }),
            ],
      ...
      h &&
        e.jsxs('div', {
          ...
          children: [
            e.jsx(z, { className: 'h-8 w-8 sm:h-10 sm:w-10 animate-spin text-muted-foreground' }),
            e.jsx('span', {
        ...
        e.jsxs('div', {
          ...
          children: [
            ...
            !a &&
              e.jsx(l, {
                asChild: !0,
                children: e.jsx(n, { to: '/dossiers/create', children: t('action.create') }),
              }),
          ],
        }),
      !h &&
              ...
              e.jsxs('div', {
                ...
                children: [
                  ...
                  e.jsx('span', {
                    ...
                    children: t('list.pageInfo', { current: o, total: Math.ceil(i.total / x) }),
                  }),
                  e.jsx(l, {
                    variant: 'outline',
                    disabled: o * x >= i.total,
                    onClick: () => f((s) => s + 1),
...
//# sourceMappingURL=index-DJkFe6AX.js.map
