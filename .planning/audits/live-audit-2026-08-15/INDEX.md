...
| #   | Finding                                                                                                                                                                                                                                                                                                                                                                                                                                       | Source                    |
| --- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------- |
| 1   | **No way to log out anywhere in the app.** Sidebar user card is a plain `<div>`; no topbar menu; `/settings` has no sign-out and isn't in the nav. Working dropdowns exist at `components/layout/nav-user.tsx`, `components/layout/Header.tsx` and `components/layout/header/UserMenu.tsx` — **three** orphans, none imported anywhere (lane checked `AppShell.tsx` only; the repo-wide negative was confirmed in Phase 92 planning). **[V]** | sweeper F6                |
