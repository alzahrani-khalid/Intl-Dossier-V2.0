...
- [x] **Phase 33: token-engine** — OKLCH-driven token engine (4 directions × mode × hue × density) with Tailwind v4 `@theme` + HeroUI v3 semantic bridge
- [x] **Phase 34: tweaks-drawer** — Topbar Tweaks drawer with Direction/Mode/Hue/Density/Classification/Locale controls, `localStorage` persistence, `/themes` route removal
- [x] **Phase 35: typography-stack** — Self-hosted font stacks per direction (Fraunces / Space Grotesk / Public Sans / Inter / IBM Plex / JetBrains Mono / Tajawal) with RTL display-font override
- [x] **Phase 36: shell-chrome** — 256px sidebar + 56px topbar + direction-specific classification element, GASTAT brand mark, responsive overlay-drawer behavior
- [x] **Phase 37: signature-visuals** — GlobeLoader / GlobeSpinner / FullscreenLoader / DossierGlyph (24 flags + symbol fallbacks) / Sparkline / Donut primitives
...
- [x] **Phase 39: kanban-calendar** — Reskinned horizontal-scroll Kanban (kcards, overdue border, done opacity) + 7×5 calendar grid with event pills
- [x] **Phase 40: list-pages** — Countries / Organizations / Persons / Forums / Topics / Working Groups / Engagements lists with shared `GenericListPage` and filter pills
...
**Archived v6.0 total:** 121/121 executable plans complete. Plan 33-08 is superseded by ADR-006 rather than counted as an executable closure plan.
...
| 33. Token Engine                  | v6.0      | 8/8            | Complete | 2026-05-06 |
| 34. Tweaks Drawer                 | v6.0      | 8/8            | Complete | 2026-05-06 |
| 35. Typography Stack              | v6.0      | 5/5            | Complete | 2026-05-06 |
| 36. Shell Chrome                  | v6.0      | 5/5            | Complete | 2026-05-06 |
| 37. Signature Visuals             | v6.0      | 9/9            | Complete | 2026-05-06 |
| 38. Dashboard Verbatim            | v6.0      | 10/10          | Complete | 2026-04-25 |
| 39. Kanban + Calendar             | v6.0      | 10/10          | Complete | 2026-05-06 |
| 40. List Pages                    | v6.0      | 25/25          | Complete | 2026-05-06 |
| 41. Dossier Drawer                | v6.0      | 11/11          | Complete | 2026-05-02 |
| 42. Remaining Pages               | v6.0      | 12/12          | Complete | 2026-05-02 |
| 43. RTL / A11y / Responsive Sweep | v6.0      | 18/18          | Complete | 2026-05-06 |
