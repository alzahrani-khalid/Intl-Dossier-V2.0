...
| **DEBT-08** | no emoji-as-UI (data/JSDoc carve-outs kept)                                                                                       | grep                | `rg '[\x{2600}-\x{27BF}\x{1F300}-\x{1FAFF}]' frontend/src/components frontend/src/routes -g'!**/__tests__/**'` → only data/JSDoc                                                                                                      | grep                                             |
