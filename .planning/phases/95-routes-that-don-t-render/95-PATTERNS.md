...
| `frontend/src/pages/dossiers/DossierSearchPage.tsx` (DEAD-01 error branch)                                                 | page component       | request-response   | `frontend/src/pages/AssignmentQueue.tsx:43-51`                                       | exact         |
