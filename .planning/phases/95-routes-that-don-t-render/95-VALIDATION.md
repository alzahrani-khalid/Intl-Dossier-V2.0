...
| 95-02 T2  | 95-02 | 1    | DEAD-02               | T-95-03/04      | deployed fn auth-guarded; role gate server-side                 | manifest + probe                   | `supabase functions list --project-ref zkrcjzdemdmwhearhfgg \| command grep -q assignments-queue` + `bash scripts/probe-edge-auth.sh assignments-queue`                                                                | script ✅              | ⬜ pending |
