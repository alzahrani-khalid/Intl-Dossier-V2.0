...
dependency_graph:
  ...
  affects: [frontend/src/pages/Dashboard, frontend/src/components/dashboard, frontend/src/components/kanban, frontend/src/components/unified-kanban, frontend/src/routes/_protected/kanban.tsx]
tech_stack:
  added: []
  patterns: [mobile-first-grids, progressive-disclosure, touch-target-44px, tablet-horizontal-scroll]
key_files:
  created: []
  modified:
