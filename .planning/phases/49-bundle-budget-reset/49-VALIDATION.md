...
| 49-02-01 | 02   | 1    | BUNDLE-04            | —          | `vite.config.ts` `manualChunks` adds heroui-vendor / sentry-vendor / dnd-vendor branches before `return 'vendor'`        | unit                 | `pnpm -C frontend build && grep -El '(heroui\|sentry\|dnd)-vendor' frontend/dist/assets/*.js`                                             | ✅ wired    | ⬜ pending |
