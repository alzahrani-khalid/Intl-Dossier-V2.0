...
Deliver Playwright E2E coverage for 10 critical user flows (TEST-01..TEST-10) plus CI integration with failure artifacts (TEST-11). Scope is fixed by ROADMAP.md — no new test categories or feature work. Discussion clarified the *how*, not the *what*.
