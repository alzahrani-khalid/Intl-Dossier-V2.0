...
**In progress:** v6.6 Dossier Workflow Completion — Phases 62-65 complete as of 2026-06-13 (62-63 shipped via PR #56, 64 via PR #57). Phase 64 closed the P0 positions INSERT RLS drift and shipped the working NewPositionDialog. Phase 65 mounted the engagement Positions tab on canonical position_dossier_links (engagementId IS a dossiers.id), resolved all nine round-15 inert CTAs (5 live with SQL-verified write+render paths, 4 removed), deleted the orphaned engagement_positions frontend stack, and live-verified all three criteria on staging. Phases 66-67 remain.
...
_Last updated: 2026-06-13 — v6.6 phases 62-65 complete; phases 66-67 remain. v7.0 Intelligence Engine follows._
