...
> _Corrected 2026-08-15 (Phase 92 planning): the 133 is a `supabase-js@2.3x` pin count, not a count of functions failing to validate JWTs — 161 of 163 bare-`getUser()` functions forward the caller's Authorization header and do authenticate. See the correction block in `audits/live-audit-2026-08-15/INDEX.md`. The sentence above is left as written because it records what the audit said at close._
