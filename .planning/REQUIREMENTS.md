...
- [x] **DOSS-06**: Working Group detail pages show member list with roles, meeting schedule, and deliverables tracker
- [x] **DOSS-07**: Person detail pages show engagement history chronologically with organization affiliation
...
- [x] **ABSORB-03**: Search enhanced into Cmd+K quick switcher with entity search, recent items, and command palette — advanced search page removed
...
| DOSS-06     | Phase 12 | Complete |
| DOSS-07     | Phase 12 | Complete |
