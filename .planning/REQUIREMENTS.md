...
- [x] **TASTE-02**: Active-nav fill is neutralized from indigo (`--accent-soft`) to `--surface-raised` gray; the thin 2px accent stripe is kept; indigo reserved for primary buttons/on-toggles. _(F17, LOW-MED)_
