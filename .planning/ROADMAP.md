...
4. Arabic kanban cards show a localized unit (`يوم`/`ي`) after Latin digits — no bare Latin `d`; digits stay Latin per the locked policy (§7.4)
   **Plans**: 6 plans
   ...
   - [ ] 82-02-PLAN.md — date-site migration, components slice 1: analytics/audit/legislation + chart 'ar-SA' numbers + ClassificationBar + MeetingMinutesCard (Wave 2)
   ...
   - [ ] 82-04-PLAN.md — date-site migration, pages/routes: dashboard greeting, WeekAhead, BriefsPage/MyTasks overlaps (Wave 2)
