...
--   (c) Staging coexistence: install the function, DO NOT invoke it on staging
--       (real data exists and would collide).
...
DECLARE
  ...
  v_inh_sources  text[] := ARRAY['direct','engagement','after_action','position','mou'];
...
BEGIN
  ...
  -------------------------------------------------------------------
  -- 2. Strict admin gate (matches check_first_run)
  -------------------------------------------------------------------
  SELECT EXISTS (
  ...
  SELECT
    uuid_generate_v5(v_ns, 'country.'||(c->>'key')),
    'country',
    c->>'en',
    c->>'ar',
    (c->>'en')||' — bilateral diplomatic dossier (Phase 17 seed).',
    'ملف دبلوماسي ثنائي: '||(c->>'ar')||' (بذرة المرحلة 17).',
    'active', 2, true, true, v_caller, v_caller,
    ARRAY['seed','phase-17','country']
  ...
  SELECT
    uuid_generate_v5(v_ns, 'country.'||(c->>'key')),
    c->>'iso2', c->>'iso3', c->>'cap_en', c->>'cap_ar', c->>'region', c->>'sub', true
  FROM jsonb_array_elements(v_countries) AS c
  ON CONFLICT (id) DO NOTHING;
  ...
  v_orgs := '[
    ...
    {"key":"gcc_stat","en":"GCC Statistical Centre","ar":"المركز الإحصائي لدول مجلس التعاون","code":"GCC-STAT","type":"regional","addr_en":"Muscat, Oman","addr_ar":"مسقط، عمان"},
    ...
    {"key":"escwa","en":"UN ESCWA","ar":"الإسكوا","code":"ESCWA","type":"regional","addr_en":"Beirut, Lebanon","addr_ar":"بيروت، لبنان"},
    {"key":"aitrs","en":"Arab Institute for Training and Research in Statistics","ar":"المعهد العربي للتدريب والبحوث الإحصائية","code":"AITRS","type":"regional","addr_en":"Amman, Jordan","addr_ar":"عمّان، الأردن"},
    {"key":"isi","en":"International Statistical Institute","ar":"المعهد الإحصائي الدولي","code":"ISI","type":"international","addr_en":"The Hague, Netherlands","addr_ar":"لاهاي، هولندا"},
    {"key":"eurostat","en":"Eurostat","ar":"يوروستات","code":"ESTAT","type":"regional","addr_en":"Luxembourg","addr_ar":"لوكسمبورغ"},
  ...
  SELECT
    uuid_generate_v5(v_ns, 'org.'||(o->>'key')),
    'organization',
    o->>'en', o->>'ar',
    ...
    o->>'code',
    'active', 2, true, true, v_caller, v_caller,
    ARRAY['seed','phase-17','organization']
  ...
  SELECT
    uuid_generate_v5(v_ns, 'org.'||(o->>'key')),
    o->>'code', o->>'type', o->>'addr_en', o->>'addr_ar', true
  FROM jsonb_array_elements(v_orgs) AS o
  ON CONFLICT (id) DO NOTHING;
  ...
  v_topics := '[
    ...
    {"key":"census2030","en":"Census 2030","ar":"التعداد 2030","cat":"methodology"},
    {"key":"nat_accts","en":"National Accounts Modernization","ar":"تحديث الحسابات القومية","cat":"methodology"},
    {"key":"big_data","en":"Big Data for Official Statistics","ar":"البيانات الضخمة للإحصاء الرسمي","cat":"innovation"},
  ...
  INSERT INTO dossiers (id, type, name_en, name_ar, description_en, description_ar, status, sensitivity_level, is_active, is_seed_data, created_by, updated_by, tags)
  SELECT
    uuid_generate_v5(v_ns, 'topic.'||(t->>'key')),
    'topic',
    t->>'en', t->>'ar',
    'Strategic topic: '||(t->>'en')||' (Phase 17 seed).',
    'موضوع استراتيجي: '||(t->>'ar')||' (بذرة المرحلة 17).',
    'active', 1, true, true, v_caller, v_caller,
    ARRAY['seed','phase-17','topic']
  ...
  INSERT INTO dossiers (id, type, name_en, name_ar, description_en, description_ar, status, sensitivity_level, is_active, is_seed_data, created_by, updated_by, tags)
  SELECT
    uuid_generate_v5(v_ns, 'wg.'||(w->>'key')),
    'working_group',
    w->>'en', w->>'ar',
    w->>'mandate_en', w->>'mandate_ar',
    'active', 2, true, true, v_caller, v_caller,
    ARRAY['seed','phase-17','working_group']
  ...
  SELECT
    ...
    w->>'mandate_en', w->>'mandate_ar',
    w->>'mandate_en', w->>'mandate_ar',
    'active', 'committee', true
  FROM jsonb_array_elements(v_wgs) AS w
  ON CONFLICT (id) DO NOTHING;

  -------------------------------------------------------------------
  -- 9. PERSONS (12 — including 3 elected_official via person_subtype)
  -------------------------------------------------------------------
  v_persons := '[
    {"key":"p01","en":"Dr. Fahad Al-Dosari","ar":"د. فهد الدوسري","title_en":"President, GASTAT","title_ar":"رئيس الهيئة العامة للإحصاء","subtype":"standard"},
    {"key":"p02","en":"Maha Al-Otaibi","ar":"مها العتيبي","title_en":"Director of International Cooperation","title_ar":"مديرة التعاون الدولي","subtype":"standard"},
    {"key":"p03","en":"Stefan Schweinfest","ar":"ستيفان شفاينفست","title_en":"Former Director, UNSD","title_ar":"المدير السابق لشعبة الإحصاءات","subtype":"standard"},
    {"key":"p04","en":"Dr. Sabah Al-Sayed","ar":"د. صباح السيد","title_en":"OECD Chief Statistician","title_ar":"كبير الإحصائيين بمنظمة OECD","subtype":"standard"},
    {"key":"p05","en":"Dr. Nadia Hariri","ar":"د. نادية حريري","title_en":"ESCWA Statistics Director","title_ar":"مديرة إحصاءات الإسكوا","subtype":"standard"},
    {"key":"p06","en":"Hana Al-Marri","ar":"هناء المري","title_en":"GCC-Stat Director","title_ar":"مديرة المركز الإحصائي الخليجي","subtype":"standard"},
    {"key":"p07","en":"Ahmed Bin Saleh","ar":"أحمد بن صالح","title_en":"Senior Advisor, Data Policy","title_ar":"مستشار أول لسياسات البيانات","subtype":"standard"},
    {"key":"p08","en":"Layla Mansour","ar":"ليلى منصور","title_en":"Census Program Lead","title_ar":"قائدة برنامج التعداد","subtype":"standard"},
    {"key":"p09","en":"Prof. Kenji Tanaka","ar":"أ. كنجي تاناكا","title_en":"ISI Vice President","title_ar":"نائب رئيس المعهد الإحصائي الدولي","subtype":"standard"},
    {"key":"p10","en":"HE Abdullah Al-Hakim","ar":"معالي عبدالله الحكيم","title_en":"Minister of Economy and Planning","title_ar":"وزير الاقتصاد والتخطيط","subtype":"elected_official"},
    {"key":"p11","en":"HE Dr. Sarah Al-Tamimi","ar":"معالي د. سارة التميمي","title_en":"Shura Council Member, Finance Committee","title_ar":"عضو مجلس الشورى، لجنة المالية","subtype":"elected_official"},
    {"key":"p12","en":"HE Khaled Al-Faisal","ar":"معالي خالد الفيصل","title_en":"Deputy Minister, Statistics Affairs","title_ar":"نائب وزير شؤون الإحصاء","subtype":"elected_official"}
  ]'::jsonb;

  INSERT INTO dossiers (id, type, name_en, name_ar, description_en, description_ar, status, sensitivity_level, is_active, is_seed_data, created_by, updated_by, tags)
  SELECT
    uuid_generate_v5(v_ns, 'person.'||(p->>'key')),
    'person',
    p->>'en', p->>'ar',
    (p->>'en')||' — '||(p->>'title_en')||' (Phase 17 seed).',
    (p->>'ar')||' — '||(p->>'title_ar')||' (بذرة المرحلة 17).',
    'active', 2, true, true, v_caller, v_caller,
    ARRAY['seed','phase-17','person', p->>'subtype']
  ...
  -------------------------------------------------------------------
  v_engagements := '[
    {"key":"e01","en":"Saudi-UN Bilateral Statistical Dialogue","ar":"حوار إحصائي سعودي-أممي ثنائي","type":"bilateral_visit","cat":"diplomatic","loc_en":"Riyadh","loc_ar":"الرياض"},
    {"key":"e02","en":"GCC-Stat Technical Committee","ar":"اللجنة الفنية لمركز الإحصاء الخليجي","type":"joint_committee","cat":"technical","loc_en":"Muscat","loc_ar":"مسقط"},
    {"key":"e03","en":"MoU Signing with Eurostat","ar":"توقيع مذكرة تفاهم مع يوروستات","type":"mou_signing","cat":"diplomatic","loc_en":"Luxembourg","loc_ar":"لوكسمبورغ"},
    {"key":"e04","en":"UNSD Training Workshop on Big Data","ar":"ورشة تدريب على البيانات الضخمة","type":"workshop","cat":"technical","loc_en":"New York","loc_ar":"نيويورك"},
    {"key":"e05","en":"OECD Country Review Mission","ar":"بعثة مراجعة قُطرية من OECD","type":"bilateral_visit","cat":"diplomatic","loc_en":"Paris","loc_ar":"باريس"},
    {"key":"e06","en":"ESCWA Regional Consultation","ar":"مشاورات إقليمية للإسكوا","type":"consultation","cat":"diplomatic","loc_en":"Beirut","loc_ar":"بيروت"},
    {"key":"e07","en":"IMF Data Standards Review","ar":"مراجعة معايير بيانات صندوق النقد","type":"joint_committee","cat":"technical","loc_en":"Washington","loc_ar":"واشنطن"},
    {"key":"e08","en":"Arab Statistical Forum 2026","ar":"المنتدى الإحصائي العربي 2026","type":"forum_attendance","cat":"diplomatic","loc_en":"Amman","loc_ar":"عمّان"},
    {"key":"e09","en":"AITRS Capacity Building Mission","ar":"بعثة بناء قدرات من المعهد العربي","type":"workshop","cat":"technical","loc_en":"Amman","loc_ar":"عمّان"},
    {"key":"e10","en":"G20 DGI Coordination Meeting","ar":"اجتماع تنسيق مبادرة G20","type":"joint_committee","cat":"diplomatic","loc_en":"Jakarta","loc_ar":"جاكرتا"}
  ]'::jsonb;

  INSERT INTO dossiers (id, type, name_en, name_ar, description_en, description_ar, status, sensitivity_level, is_active, is_seed_data, created_by, updated_by, tags)
  SELECT
    uuid_generate_v5(v_ns, 'engagement.'||(e->>'key')),
    'engagement',
    e->>'en', e->>'ar',
    'Diplomatic engagement: '||(e->>'en')||' (Phase 17 seed).',
    'مشاركة دبلوماسية: '||(e->>'ar')||' (بذرة المرحلة 17).',
    'active', 2, true, true, v_caller, v_caller,
    ARRAY['seed','phase-17','engagement']
  ...
  SELECT
    uuid_generate_v5(v_ns, 'engagement.'||(e->>'key')),
    e->>'type', e->>'cat', e->>'loc_en', e->>'loc_ar', true
  FROM jsonb_array_elements(v_engagements) AS e
  ON CONFLICT (id) DO NOTHING;

  -------------------------------------------------------------------
  -- 11. TASKS (50 — full enum coverage)
  -------------------------------------------------------------------
  -- Cycle through all enum values using modulo arithmetic so every
  -- status/priority/type/workflow_stage/source_kind appears ≥3 times.
  FOR v_i IN 1..50 LOOP
    ...
    INSERT INTO tasks (
      ...
      'مهمة بذرة رقم '||v_i::text||': سيناريو GASTAT الدبلوماسي (بذرة المرحلة 17 — تغطية كاملة للحالات).',
      ...
      jsonb_build_object(
        'start_date', (now() - (v_i || ' days')::interval)::text,
        'due_date',   (now() + ((30 - v_i) || ' days')::interval)::text
      ),
      -- Mix of overdue, today, and future sla_deadlines
    ...
    -- Link each task to 1-2 dossiers (country + org cross-tier) via polymorphic work_item_dossiers
    -- Primary link: country (cycle through 10 seeded countries)
    INSERT INTO work_item_dossiers (
      ...
      v_task_id, 'task',
      v_country_ids[((v_i-1) % 10) + 1],
      v_inh_sources[((v_i-1) % 5) + 1],
      true, 0, v_caller, true
    )
    ON CONFLICT DO NOTHING;

    -- Secondary link for ~30% of tasks: organization (different inheritance_source)
    IF v_i % 3 = 0 THEN
      INSERT INTO work_item_dossiers (
        work_item_id, work_item_type, dossier_id, inheritance_source,
        is_primary, display_order, created_by, is_seed_data
        ...
        v_task_id, 'task',
        v_org_ids[((v_i-1) % 10) + 1],
        v_inh_sources[((v_i) % 5) + 1],
...
COMMENT ON FUNCTION public.populate_diplomatic_seed() IS
  'Phase 17 GASTAT diplomatic seed RPC. Admin-only, idempotent on empty, deterministic UUIDs. Uses typed-dossier 1:1 PK inheritance (dossiers holds bilingual name, typed tables hold metadata). Hardcodes default tenant 00000000-0000-0000-0000-000000000001. Do NOT invoke on staging (real data exists and would collide). See 17-SCHEMA-RECONCILIATION.md §10.';
