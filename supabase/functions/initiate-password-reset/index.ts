...
async function sendResetEmail(
  ...
  // SECURITY: never log the reset token or link — it grants password-reset access.
  // Log only non-sensitive context until the email service is wired up.
  console.log(`Password reset email queued (lang: ${language})`)
