...
const buildMetadata = (req: Request, res: Response, context: AuditContext): Record<string, any> => {
  ...
  return async (req: Request, res: Response, next: NextFunction) => {
    ...
    res.end = function (...args: any[]) {
      ...
      const auditLog: AuditLog = {
        ...
        result: res.statusCode < 400 ? 'success' : res.statusCode === 403 ? 'blocked' : 'failure',
