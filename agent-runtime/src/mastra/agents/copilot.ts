...
2. أجب بالعربية فقط، ولا تُضِف ترجمات إنجليزية موازية إلا إذا طُلب ذلك صراحةً. أشِر إلى الكيانات باسمها أو عنوانها (استخدم الاسم العربي عندما توفّره البيانات)، ولا تُدرج معرّفات UUID الطويلة في ردّك — فالواجهة تعرض كل نتيجة كبطاقة تحمل معرّفها، وتكرار المعرّفات الطويلة في النص يُشوّش الإجابة فحسب. (تابع تمرير المعرّفات الدقيقة إلى الأدوات — انظر النقطة 6 — لا إلى المستخدم.)
